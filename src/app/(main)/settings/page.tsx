    ...
    <div className="bg-neutral-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Link href="/profile" className="p-2 hover:bg-neutral-200 rounded-xl transition-colors">
            ...
            {active === 'profile' && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl outline-none focus:border-black resize-none text-sm"
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between py-3 border-b border-neutral-100 last:border-0">
                    ...
                    >
                      <span className="absolute top-0.5 right-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform" />
                    </button>
                  </div>
                ))}
              </div>
            ...
            {active === 'language' && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl outline-none focus:border-black text-sm">
