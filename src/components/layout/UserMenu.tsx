...
export function UserMenu() {
  ...
  if (!session?.user) {
    return (
      <Link
        href="/login"
        className="ml-2 flex items-center gap-2 px-4 py-2 bg-black text-white rounded-full text-sm font-bold hover:bg-neutral-800"
      >
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-12 w-72 bg-white rounded-2xl shadow-2xl border border-neutral-200 overflow-hidden">
          <div className="p-5 bg-gradient-to-br from-yellow-50 to-orange-50">
          ...
          <div className="p-2">
            <Link
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-neutral-50 rounded-lg text-sm"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 hover:bg-neutral-50 rounded-lg text-sm text-red-600"
            >
